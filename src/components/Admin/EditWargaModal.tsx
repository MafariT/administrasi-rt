  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            Edit Data Warga: {details?.full_name || warga.full_name}
          </DialogTitle>
        </DialogHeader>
        {isLoading ? (
          ...
          <form action={handleUpdate} className="space-y-4 pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label>NIK</Label>
                <Input name="nik" defaultValue={details.nik ?? ''} />
              </div>
              <div className="space-y-2">
                <Label>Nomor KK</Label>
                <Input name="nomor_kk" defaultValue={details.nomor_kk ?? ''} />
              </div>
              <div className="space-y-2">
                <Label>Tempat Lahir</Label>
                <Input
                  name="tempat_lahir"
                  defaultValue={details.tempat_lahir ?? ''}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  type="date"
                  name="tanggal_lahir"
                  defaultValue={details.tanggal_lahir ?? ''}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  name="pekerjaan"
                  defaultValue={details.pekerjaan ?? ''}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  defaultValue={details.kewarganegaraan ?? 'WNI'}
                />
              </div>
              <div className="space-y-2">
                <Label>Telepon</Label>
              ...
              <div className="space-y-2">
                ...
                <Select
                  name="jenis_kelamin"
                  defaultValue={details.jenis_kelamin ?? ''}
                >
              ...
              <div className="space-y-2">
                <Label>Agama</Label>
                <Select name="agama" defaultValue={details.agama ?? ''}>
                  <SelectTrigger className="w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  defaultValue={details.status_perkawinan ?? ''}
                >
                  <SelectTrigger className="w-full">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  defaultValue={details.status_tempat_tinggal ?? ''}
                >
                  <SelectTrigger className="w-full">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select name="status" defaultValue={details.status}>
                  <SelectTrigger className="w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                name="alamat_ktp"
                defaultValue={details.alamat_ktp ?? ''}
              />
            </div>
            <div className="space-y-2">
              ...
              <Textarea
                ...
                defaultValue={details.alamat_domisili ?? ''}
              />
            </div>
