  ...
  return (
    <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-2xl border border-gray-200 shadow-lg">
      ...
      <p className="text-center text-gray-500 text-sm">
        {isRegisterMode
          ? 'Mulai dengan membuat akun anda'
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-2 mt-1 bg-white border border-gray-300 rounded-md focus:ring-primary focus:border-primary text-gray-600"
          />
        </div>

        <div className="relative">
          <label className="text-sm font-medium text-gray-600">
            {isRegisterMode ? 'Buat password *' : 'Password'}
          </label>
          <input
          ...
          <button
            ...
            className="absolute inset-y-0 right-0 top-6 pr-3 flex items-center text-gray-500 hover:text-primary"
          >
