...
export const wargaSchema = z.object({
  ...
  nik: z.string().length(16, { message: "NIK harus terdiri dari 16 digit angka." }).regex(/^\d+$/, "NIK hanya boleh berisi angka."),
  nomor_kk: z.string().length(16, { message: "Nomor KK harus terdiri dari 16 digit angka." }).regex(/^\d+$/, "Nomor KK hanya boleh berisi angka."),
